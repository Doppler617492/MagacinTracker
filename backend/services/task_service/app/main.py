...
from .routers import ai_recommendations, auth_test, edge, health, internal_catalog, kafka, kpi, kpi_predict, metrics, reports, trebovanja, tv, users_simple, worker_picking, zaduznice
